...
export const Vipinformation = () => {

    return (
<div className="chat-container">
<h2> BAS </h2>
<p> ✅ Matcha med andra användare</p>
<p> ✅ Skicka en förfrågan när ni matchar</p>
<p> ❌ Återställa nekade användare</p>
<p> ❌ Få begränsad med information om användare</p>
